...
exports.detectTokenNetwork = exports.detectTradeNetwork = exports.tokenExists = exports.providerFromChainId = exports.NETWORKS = exports.WETH_ADDRESSES = void 0;
...
const providerFromChainId = (chainId = 1) => {
    return exports.NETWORKS.find((p) => p.chainId === chainId).provider;
};
