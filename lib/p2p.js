...
const mapToBuffers = (o) => (0, lodash_1.mapValues)(o, (v) => base64url(v.toByteArray && buffer_1.Buffer.from(v.toByteArray()) || buffer_1.Buffer.from((0, ethers_1.hexlify)(v).substr(2), 'hex')));
