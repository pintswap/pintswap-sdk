...
exports.PintP2P = exports.cryptoFromSeed = exports.fromJSONtoBuffer = exports.fromBufferToJSON = exports.stringToBuffer = exports.bufferToString = void 0;
...
const cryptoFromSeed = function (seed) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        key.dq = key.dmq1;
        key.qi = key.coeff;
        return libp2p_crypto_1.default.keys.unmarshalPrivateKey(yield libp2p_crypto_1.default.keys.marshalPrivateKey(new libp2p_crypto_1.default.keys.supportedKeys.rsa.RsaPrivateKey(key, key)));
    });
};
...
class PintP2P extends libp2p_1.default {
    ...
    static peerIdFromSeed(seed) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield peer_id_1.default.createFromPrivKey(libp2p_crypto_1.default.keys.marshalPrivateKey(yield (0, exports.cryptoFromSeed)(seed)));
        });
    }
