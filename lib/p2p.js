...
const mapToBuffers = (o) => (0, lodash_1.mapValues)(o, (v) => base64url_1.default((v.toByteArray && buffer_1.Buffer.from(v.toByteArray())) ||
    (0, ethers_2.hexlify)(buffer_1.Buffer.from([v]))));
...
class PintP2P extends libp2p_1.default {
    ...
    get address() {
        return this.constructor.toAddress(this.peerId.toB58String());
    }
    ...
    setSigner(signer) {
        ...
        this.addressPromise = this.signer
            ...
            : Promise.resolve(ethers_1.ethers.ZeroAddress);
    }
    constructor(options) {
...
PintP2P.PRESETS = {
    MAINNET: constants_2.SIGNAL_SERVER,
};
PintP2P.PREFIX = "pint";
