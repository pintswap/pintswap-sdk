...
function encode(request) {
    const payload = protocol_1.protocol.PermitData.encode((0, lodash_1.mapValues)({ v: request.v, r: request.r, s: request.s, expiry: request.expiry }, (v) => Buffer.from((0, ethers_1.toBeArray)((0, ethers_1.hexlify)(String(v)))))).finish();
    return payload;
}
