...
exports.decode = exports.encode = exports.sign = exports.joinSignature = exports.splitSignature = exports.toEIP712 = exports.getDomain = exports.toNetwork = exports.toChainId = exports.getPermitStructure = exports.isUSDC = exports.fetchData = exports.getDomainStructure = exports.getMessage = exports.ASSETS = void 0;
...
function fetchData(o, provider) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign(Object.assign({}, o), { nonce: yield contract.nonces(o.spender), name: yield contract.name() });
    });
}
...
exports.sign = sign;
function encode(request, signature) {
    const payload = protocol_1.protocol.PermitData.encode((0, lodash_1.mapValues)(Object.assign(Object.assign({}, signature), { expiry: request.expiry }), (v) => Buffer.from((0, ethers_1.toBeArray)((0, ethers_1.hexlify)(String(v)))))).finish();
    return payload;
}
exports.encode = encode;
function decode(data) {
    const permitData = (0, lodash_1.mapValues)(protocol_1.protocol.PermitData.toObject(protocol_1.protocol.PermitData.decode(data), {
        enums: String,
        longs: String,
        bytes: String,
        defaults: true,
        ...
        objects: true,
        oneofs: true,
    }), (v) => (0, ethers_1.hexlify)((0, ethers_1.decodeBase64)(v)));
    return {
