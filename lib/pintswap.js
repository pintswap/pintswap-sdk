...
class Pintswap extends p2p_1.PintP2P {
    ...
    handleBroadcastedOffers() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.handle("/pintswap/0.1.0/orders", ({ stream }) => {
                ...
                let _offerList = protocol_1.protocol.OfferList.encode({ offers: [...this.offers.values()] }).finish();
    ...
    getTradesByPeerId(peerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const offer = protocol_1.protocol.OfferList.toObject(protocol_1.protocol.OfferList.decode(result), {
                enums: String,
                longs: String,
                bytes: String,
                defaults: true,
