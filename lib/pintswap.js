...
exports.Pintswap = exports.sumOffers = exports.toBigIntFromBytes = exports.scaleOffer = exports.decodeBatchFill = exports.encodeBatchFill = exports.PintswapTrade = exports.sendFlashbotsTransaction = void 0;
...
function scaleOffer(offer, amount) {
    ...
    return {
        ...
        givesAmount: ethers_1.ethers.hexlify(ethers_1.ethers.toBeArray((ethers_1.ethers.getUint(offer.givesAmount) * ethers_1.ethers.getUint(amount)) / ethers_1.ethers.getUint(offer.getsAmount))),
