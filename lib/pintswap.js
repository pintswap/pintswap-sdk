...
const maybeConvertName = (s) => {
    if (s.indexOf('.') !== -1 || s.substr(0, p2p_1.PintP2P.PREFIX.length) === p2p_1.PintP2P.PREFIX)
        return s;
...
class Pintswap extends p2p_1.PintP2P {
    ...
    dialPeer(...args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.dialProtocol.apply(this, [peer_id_1.default.createFromB58String(this.constructor.fromAddress(peerId)), ...rest]);
        });
    }
    resolveName(name) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    findPeer(pintSwapAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resolved = this.constructor.fromAddress(pintSwapAddress.indexOf('.') !== -1 ? yield this.resolveName(pintSwapAddress) : pintSwapAddress);
    ...
    _decodeMakerBroadcast(data) {
        let offerList = protocol_1.protocol.MakerBroadcast.toObject(protocol_1.protocol.MakerBroadcast.decode(data), {
            enums: String,
            longs: String,
            bytes: String,
            defaults: true,
    ...
    approveTrade(transfer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.logger.debug("balance::" + ethers_1.ethers.formatEther(yield token.balanceOf(yield this.signer.getAddress())));
            if (transfer.token === ethers_1.ethers.ZeroAddress) {
                ...
                this.logger.debug("weth-balance::" + ethers_1.ethers.formatEther(yield weth.balanceOf(yield this.signer.getAddress())));
            }
            if (yield (0, detect_permit_1.detectPermit)(transfer.token, this.signer)) {
                ...
                this.logger.debug("balance::after-approve::" + ethers_1.ethers.formatEther(yield token.balanceOf(yield this.signer.getAddress())));
                this.logger.debug("allowance::after-approve::" + ethers_1.ethers.formatEther(yield token.allowance(yield this.signer.getAddress(), tradeAddress)));
                return tx;
            }
        });
    }
    ...
    _keygenMPC({ i, input, context }) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (i) {
                case 'KEYGEN_A0':
                    return yield two_party_ecdsa_js_1.TPCEcdsaKeyGen.P1Context.createContext();
                case 'KEYGEN_A1':
    ...
    _signMPC({ i, keyshareJson, m, context, input }) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (i) {
                case 'SIGN_A0': // TODO
                    return yield two_party_ecdsa_js_1.TPCEcdsaSign.P1Context.createContext(keyshareJson, m);
                case 'SIGN_A1': // TODO
                    return context.step1();
                case 'SIGN_A2': // TODO
                    return context.step2(input);
    ...
    createBatchTrade(peer, batchFill) {
        ...
        (() => __awaiter(this, void 0, void 0, function* () {
            ...
            const context1 = yield this._keygenMPC({ i: 'KEYGEN_A0' });
            this.logger.debug('keygen::context::complete');
            this.logger.debug('keygen::step1::compute');
            // const message1 = context1.step1();
            const message1 = yield this._keygenMPC({ i: 'KEYGEN_A1', context: context1 });
            ...
            (0, it_pipe_1.pipe)(stream.source, lp.decode(), function (source) {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        messages.push(yield this._keygenMPC({ context: context1, i: 'KEYGEN_A2', input: keygenMessage2 }));
                        ...
                        //   new BN(_uhash, 16)
                        // );
                        const signContext = yield this._signMPC({
                            i: 'SIGN_A0',
                            keyshareJson: JSON.stringify(keyshareJson, null, 4),
                            m: new bn_js_1.default(_uhash, 16)
                        });
                        self.logger.debug('sign-context::complete');
                        ...
                        messages.push(yield this._signMPC({ i: 'SIGN_A1', context: signContext }));
                        self.logger.debug('sign::step1::complete');
                        ...
                        messages.push(yield this._signMPC({ i: 'SIGN_A2', context: signContext, input: signMessage_2.slice() }));
                        self.logger.debug('sign::step2::complete');
                        ...
                        yield this._signMPC({ i: 'SIGN_B0', context: signContext, input: signMessage_4.slice() });
