...
exports.Pintswap = exports.mapToBuffers = exports.testLongConvert = exports.testMapToBuffers = exports.cryptoFromSeed = void 0;
...
const cryptoFromSeed = function (seed) {
    return __awaiter(this, void 0, void 0, function* () {
        const key = (0, exports.mapToBuffers)(yield cryptico_js_1.default.generateRSAKey(seed, 2048));
        key.dp = key.dmp1;
        key.dq = key.dmq1;
        key.qi = key.coeff;
...
const testMapToBuffers = function (seed) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield cryptico_js_1.default.generateRSAKey(seed, 2048);
    });
};
exports.testMapToBuffers = testMapToBuffers;
const testLongConvert = function (key) {
    return libp2p_crypto_1.default.keys.supportedKeys.rsa.unmarshalRsaPrivateKey(new libp2p_crypto_1.default.keys.supportedKeys.rsa.RsaPrivateKey(key, key).marshal());
};
exports.testLongConvert = testLongConvert;
const mapToBuffers = (o) => (0, lodash_1.mapValues)(o, (v) => base64url_1.default(v.toByteArray && Buffer.from(v.toByteArray()) || hexlify(Buffer.from([v]))));
exports.mapToBuffers = mapToBuffers;
class Pintswap extends p2p_1.PintP2P {
    static initialize({ signer }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                try {
                    let peerId = peer_id_1.default.createFromPrivKey((yield (0, exports.cryptoFromSeed)(yield signer.getAddress())).bytes);
    ...
    handleBroadcastedOffers() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.handle("/pintswap/0.1.0/orders", (duplex) => {
                ...
                (0, it_pipe_1.pipe)(duplex.stream.sink, lp.encode(), protocol_1.protocol.OfferList.encode({ offers: this.offers.values() }));
            });
