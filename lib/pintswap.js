...
class Pintswap extends p2p_1.PintP2P {
    ...
    handleBroadcastedOffers() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.handle("/pintswap/0.1.0/orders", (duplex) => {
                ...
                (0, it_pipe_1.pipe)(messages, lp.encode(), duplex.stream.sink);
                console.log("offerList:", protocol_1.protocol.OfferList);
                console.log("encodedOfferList:", protocol_1.protocol.OfferList.encode({ offers: this.offers.values() }));
                messages.push(protocol_1.protocol.OfferList.encode({ offers: this.offers.values() }).finish());
                messages.end();
            });
    ...
    getTradesByPeerId(peerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //   }
            // )
            const result = yield (yield (0, it_pipe_1.pipe)(stream.source, lp.decode()).next());
