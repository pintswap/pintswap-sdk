...
class Pintswap extends p2p_1.PintP2P {
                    ...
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            const payCoinbaseAmount = payCoinbaseAmountBuffer.length
                                ? ethers_1.ethers.hexlify(ethers_1.ethers.toBeArray(payCoinbaseAmountBuffer))
                                : null;
    ...
    approveTradeAsMaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (offer.givesToken === ethers_1.ethers.ZeroAddress) {
                ...
                const depositTx = yield new ethers_1.ethers.Contract((0, trade_1.toWETH)(chainId), ["function deposit()"], this.signer).deposit({ value: offer.givesAmount });
    ...
    approvePermit2(asset) {
        return __awaiter(this, void 0, void 0, function* () {
            const token = new Contract(asset, trade_2.genericAbi, this.signer);
    ...
    approveTradeAsTaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (offer.getsToken === ethers_1.ethers.ZeroAddress) {
                const { chainId } = yield this.signer.provider.getNetwork();
                const depositTx = yield new ethers_1.ethers.Contract((0, trade_1.toWETH)(chainId), ["function deposit()"], this.signer).deposit({ value: offer.getsAmount });
                if (this._awaitReceipts)
                    yield this.signer.provider.waitForTransaction(depositTx.hash);
            }
    ...
    prepareTransaction(offer, maker, sharedAddress, permitData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const payCoinbase = Boolean(chainId === 1 &&
                [offer.givesToken, offer.getsToken].find((v) => v === (0, trade_1.toWETH)(1) || ethers_1.ethers.ZeroAddress));
            ...
            (0, it_pipe_1.pipe)(stream.source, lp.decode(), function (source) {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        messages.push(Buffer.from(ethers_1.ethers.toBeArray(payCoinbaseAmount || "0x")));
