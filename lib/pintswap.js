...
function scaleOffer(offer, amount) {
    if (ethers_1.ethers.getUint(amount) > ethers_1.ethers.getUint(offer.getsAmount))
        throw Error("fill amount exceeds order capacity");
    return {
        givesToken: offer.givesToken,
        getsToken: offer.getsToken,
        givesAmount: ethers_1.ethers.hexlify(ethers_1.ethers.toBeArray((ethers_1.ethers.getUint(offer.givesAmount) * ethers_1.ethers.getUint(amount)) /
            ethers_1.ethers.getUint(offer.getsAmount))),
        getsAmount: ethers_1.ethers.hexlify(ethers_1.ethers.toBeArray(ethers_1.ethers.getUint(amount))),
    };
}
...
function sumOffers(offers) {
    return offers.reduce((r, v) => ({
        ...
        getsAmount: ethers_1.ethers.toBeHex(toBigIntFromBytes(v.getsAmount) + toBigIntFromBytes(r.getsAmount)),
        givesAmount: ethers_1.ethers.toBeHex(toBigIntFromBytes(v.givesAmount) + toBigIntFromBytes(r.givesAmount)),
    }), { getsAmount: ethers_1.ethers.toBigInt(0), givesAmount: ethers_1.ethers.toBigInt(0) });
}
...
class Pintswap extends p2p_1.PintP2P {
    ...
    static fromObject(o, signer) {
        return __awaiter(this, void 0, void 0, function* () {
            const initArg = Object.assign(Object.assign({}, o), { userData: o.userData && {
                ...
                }, offers: o.offers && new Map(o.offers.map((v) => [(0, trade_2.hashOffer)(v), v])), peerId: o.peerId && (yield peer_id_1.default.createFromJSON(o.peerId)), signer });
                ...
                (0, it_pipe_1.pipe)(stream.source, lp.decode(), function (source) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            ...
                            if ((0, lodash_1.uniq)(offers.map((v) => ethers_1.ethers.getAddress(v.getsToken))).length !==
                                1 ||
                                (0, lodash_1.uniq)(offers.map((v) => ethers_1.ethers.getAddress(v.givesToken)))
                                    .length !== 1)
    ...
    approveTradeAsMaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield (0, detect_permit_1.detectPermit)(offer.givesToken, this.signer)) {
    ...
    approveTradeAsTaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield (0, detect_permit_1.detectPermit)(offer.getsToken, this.signer)) {
                const expiry = Math.floor(Date.now() / 1000) + 60 * 60 * 24;
                const permitData = yield permit.sign({
