...
exports.NS_MULTIADDRS = {
    DRIP: [p2p_1.PintP2P.toAddress("QmTABj5y3Q7LPErKeEPyNHKakp4gAknfwFEAm6LsD6TaNT")],
            ...
            (0, it_pipe_1.pipe)(stream.source, lp.decode(), function (source) {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        const keygenMessage2BufList = (step2keygen === null || step2keygen === void 0 ? void 0 : step2keygen.value) || [];
                        ...
                        const permitData = yield (0, timeout_1.reqWithTimeout)(source.next(), 60);
