    ...
    static initialize({ signer }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!signer.getAddress())
                return new Error(`ERROR: pintswap-sdk.ts: invalid signer?`);
            let peerId = yield Pintswap.peerIdFromSeed(yield signer.getAddress());
            if (!peerId)
                return new Error(`ERROR: pintswap-sdk.ts: failed to create peerId`);
