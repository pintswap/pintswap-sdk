...
class Pintswap extends p2p_1.PintP2P {
    ...
    handleBroadcastedOffers() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.handle("/pintswap/0.1.0/orders", ({ stream }) => {
                ...
                console.log(_offerList, "offerList being broadcast");
    ...
    getTradesByPeerId(peerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return protocol_1.protocol.OfferList.toObject(protocol_1.protocol.OfferList.decode(result), {
                enums: String,
                longs: String,
                bytes: String,
                defaults: true,
                ...
                objects: true,
                oneofs: true
            }).offers.map((v) => (0, lodash_1.mapValues)(v, (v) => ethers_1.ethers.hexlify(v)));
        });
    }
