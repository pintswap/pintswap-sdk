...
class Pintswap extends p2p_1.PintP2P {
    ...
    handleBroadcastedOffers() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.handle("/pintswap/0.1.0/orders", (duplex) => (0, it_pipe_1.pipe)(duplex.stream.sink, lp.encode(), protocol_1.protocol.OfferList.encode({ offers: this.offers.values() })));
