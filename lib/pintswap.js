...
exports.Pintswap = exports.PintswapTrade = exports.sendFlashbotsTransaction = void 0;
...
class Pintswap extends p2p_1.PintP2P {
    ...
    publishOffers() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.pubsub.publish('/pintswap/0.1.0/publish-orders', this._encodeOffers());
        });
    }
    ...
    subscribeOffers() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.pubsub.subscribe('/pintswap/0.1.0/publish-orders');
            this.pubsub.addListener('message', (message) => {
                if (message.detail.topic !== '/pintswap/0.1.0/publish-orders')
                    return;
                ...
                (0, it_pipe_1.pipe)(stream.source, lp.decode(), function (source) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        try {
                            ...
                            offerHashHex = ethers_1.ethers.hexlify(offerHashBufList.slice());
                           ...
                           */
                            ...
                            if (offer && offerHashHex)
                                self.offers.set(offerHashHex, offer);
                            self.logger.error(e);
                            trade.reject(e);
                        }
                    });
    ...
    approveTradeAsMaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (offer.givesToken === ethers_1.ethers.ZeroAddress) {
                ...
                const weth = new ethers_1.ethers.Contract((0, trade_1.toWETH)(Number(chainId)), ['function deposit()', 'function balanceOf(address) view returns (uint256)'], this.signer);
                const depositTx = yield weth.deposit({ value: offer.givesAmount });
                if (this._awaitReceipts)
                    yield this.signer.provider.waitForTransaction(depositTx.hash);
                this.logger.debug('MAKER: WETH BALANCE ' + ethers_1.ethers.formatEther(yield weth.balanceOf(yield this.signer.getAddress())));
            }
            if (getAddress(offer.givesToken) === getAddress(permit.ASSETS.ETHEREUM.USDC)) {
                ...
                const tx = yield this.approvePermit2(offer.givesToken);
                if (tx && this._awaitReceipts)
                    yield this.signer.provider.waitForTransaction(tx.hash);
                const signatureTransfer = {
                    permit: {
                        permitted: {
                            token: yield (0, trade_2.coerceToWeth)(offer.givesToken, this.signer),
    ...
    approveTradeAsTaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const tradeAddress = yield this.getTradeAddress(sharedAddress);
            const address = yield (0, trade_2.coerceToWeth)(getAddress(offer.getsToken), this.signer);
            ...
            if (offer.getsToken === ethers_1.ethers.ZeroAddress) {
                const { chainId } = yield this.signer.provider.getNetwork();
                const weth = new ethers_1.ethers.Contract((0, trade_1.toWETH)(Number(chainId)), ['function deposit()', 'function balanceOf(address) view returns (uint256)'], this.signer);
                const depositTx = yield weth.deposit({ value: offer.getsAmount });
                if (this._awaitReceipts)
                    yield this.signer.provider.waitForTransaction(depositTx.hash);
                this.logger.debug('TAKER: WETH BALANCE ' + ethers_1.ethers.formatEther(yield weth.balanceOf(yield this.signer.getAddress())));
            }
            if (getAddress(offer.getsToken) === getAddress(permit.ASSETS.ETHEREUM.USDC)) {
                ...
                const tx = yield this.approvePermit2(offer.getsToken);
                if (tx && this._awaitReceipts)
                    yield this.signer.provider.waitForTransaction(tx.hash);
                const signatureTransfer = {
                    permit: {
                        permitted: {
                            token: yield (0, trade_2.coerceToWeth)(offer.getsToken, this.signer),
    ...
    prepareTransaction(offer, maker, sharedAddress, permitData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const payCoinbase = Boolean(false &&
                [offer.givesToken, offer.getsToken].find((v) => ethers_1.ethers.ZeroAddress === v));
            ...
            const gasPrice = (0, trade_2.toBigInt)(yield getGasPrice(this.signer.provider));
    ...
    createTrade(peer, offer) {
        const trade = new PintswapTrade();
        trade.hash = (0, trade_2.hashOffer)(offer);
        this.emit("trade:taker", trade);
        (() => __awaiter(this, void 0, void 0, function* () {
            this.logger.debug(`Acting on offer ${trade.hash} with peer ${peer}`);
            ...
            (0, it_pipe_1.pipe)(stream.source, lp.decode(), function (source) {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        messages.push(Buffer.from(ethers_1.ethers.toBeArray(trade.hash)));
                        ...
                        messages.push(payCoinbaseAmount ? Buffer.from(ethers_1.ethers.toBeArray(payCoinbaseAmount)) : Buffer.from([]));
                        ...
                        let txHash;
                        if (tx.maxPriorityFeePerGas && ethers_1.ethers.getUint(tx.maxPriorityFeePerGas) === BigInt(0)) {
