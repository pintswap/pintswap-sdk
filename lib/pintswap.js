...
class Pintswap extends p2p_1.PintP2P {
    ...
    handleBroadcastedOffers() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.handle("/pintswap/0.1.0/orders", ({ stream }) => {
                ...
                (0, it_pipe_1.pipe)(protocol_1.protocol.OfferList.encode({ offers: this.offers.values() }).finish(), lp.encode(), stream.sink);
            });
    ...
    getTradesByPeerId(peerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = (0, it_pipe_1.pipe)(stream.source, lp.decode(), function collect(source) {
