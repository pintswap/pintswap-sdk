...
class Pintswap extends p2p_1.PintP2P {
    ...
    createTransaction(offer, maker, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gasPrice = toBigInt(yield this.signer.provider.getGasPrice());
            const gasLimit = toBigInt(yield this.signer.provider.estimateGas({
                data: contract,
                from: sharedAddress,
                gasPrice,
            }));
            let sharedAddressBalance = toBigInt(yield this.signer.provider.getBalance(sharedAddress));
