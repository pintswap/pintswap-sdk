...
class Pintswap extends p2p_1.PintP2P {
                ...
                (0, it_pipe_1.pipe)(stream.source, lp.decode(), function (source) {
                    return __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            if (ethers_1.ethers.getUint(transaction.gasPrice) >
                                BigInt(500000) * BigInt(yield self.signer.provider.getGasPrice())) {
                            ...
                            if (transaction.data !==
                                (0, trade_2.createContract)(offer, yield self.signer.getAddress(), takerAddress, (yield self.signer.provider.getNetwork()).chainId, contractPermitData, payCoinbaseAmount))
    ...
    approveTradeAsMaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (offer.givesToken === ethers_1.ethers.ZeroAddress) {
                ...
                const weth = new ethers_1.ethers.Contract((0, trade_1.toWETH)(chainId), ['function deposit()', 'function balanceOf(address) view returns (uint256)'], this.signer);
            ...
            if (getAddress(offer.givesToken) === getAddress(permit.ASSETS.ETHEREUM.USDC)) {
            ...
            else if ((yield this.signer.provider.getNetwork()).chainId === 1) {
                ...
                const signature = yield this.signer._signTypedData(...getPermitData(signatureTransfer));
                return {
                    permitData: {
    ...
    prepareTransaction(offer, maker, sharedAddress, permitData) {
        return __awaiter(this, void 0, void 0, function* () {
            const chainId = (yield this.signer.provider.getNetwork()).chainId;
            const payCoinbase = Boolean(chainId === 1 &&
            ...
            (0, it_pipe_1.pipe)(stream.source, lp.decode(), function (source) {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        let txReceipt;
                        if (ethers_1.ethers.getUint(tx.gasPrice) === BigInt(0)) {
                            const provider = new ethers_1.ethers.JsonRpcProvider("https://rpc.flashbots.net");
                            txReceipt = yield provider.broadcastTransaction(tx.serialized);
                        }
                        else {
                            txReceipt =
