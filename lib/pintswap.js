...
exports.setFallbackWETH = exports.Pintswap = void 0;
...
class Pintswap extends p2p_1.PintP2P {
            ...
            yield this.handle("/pintswap/0.1.0/create-trade", ({ stream, connection, protocol }) => __awaiter(this, void 0, void 0, function* () {
                ...
                _event.on("/event/ecdsa-sign/party/2/init", (serializedTx) => __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        if (transaction.data !==
                            (0, trade_2.createContract)(offer, yield this.signer.getAddress(), takerAddress))
    ...
    broadcastOffer(_offer) {
        ...
        this.offers.set((0, trade_2.hashOffer)(_offer), _offer);
    }
    ...
    approveTradeAsMaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const token = new Contract(yield coerceToWeth(ethers_1.ethers.getAddress(offer.givesToken), this.signer), [
    ...
    approveTradeAsTaker(offer, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const tradeAddress = yield this.getTradeAddress(sharedAddress);
            const token = new Contract(yield coerceToWeth(getAddress(offer.getsToken), this.signer), [
                "function approve(address, uint256) returns (bool)",
                "function allowance(address, address) view returns (uint256)",
                "function balanceOf(address) view returns (uint256)",
            ], this.signer);
    ...
    prepareTransaction(offer, maker, sharedAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const contract = (0, trade_2.createContract)(offer, maker, yield this.signer.getAddress());
            const gasPrice = (0, trade_2.toBigInt)(yield this.signer.provider.getGasPrice());
            const gasLimit = (0, trade_2.toBigInt)(yield this.signer.provider.estimateGas({
                data: contract,
                from: sharedAddress,
                gasPrice,
            })) + BigInt(26000);
...
var trade_3 = require("./trade");
Object.defineProperty(exports, "setFallbackWETH", { enumerable: true, get: function () { return trade_3.setFallbackWETH; } });
