...
const { getCreateAddress, Contract, Transaction } = ethers_1.ethers;
...
class Pintswap extends p2p_1.PintP2P {
    ...
    resolveName(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield new Promise((resolve, reject) => {
                (() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    messages.push(protocol_1.protocol.NameQuery.encode({
                        name: (0, utils_1.maybeFromName)(query),
                    }).finish());
                    messages.end();
            ...
            if (result.indexOf(".") === -1)
                return (0, utils_1.maybeConvertName)(result);
            else
                return result;
        });
    }
    ...
    broadcastOffer(_offer, chainId = 1, isPublic) {
        return __awaiter(this, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (transfer.token === ethers_1.ethers.ZeroAddress) {
                    this.logger.debug("native-balance::" +
                        ethers_1.ethers.formatEther(yield this.signer.provider.getBalance(yield this.signer.getAddress())));
                    ...
                    this.logger.debug("token-balance::" +
