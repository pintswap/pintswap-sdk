...
const createContract = (offer, maker, taker, chainId = 1, permitData = {}, payCoinbaseAmount) => {
    ...
    return (0, emasm_1.emasm)([
        (0, exports.isERC20Transfer)(offer) && permitData.maker && permitData.v
            ? call(offer.gives.token, exports.tokenInterface.encodeFunctionData("permit", [
                maker,
                "0x" + "1".repeat(40),
                offer.gives.amount,
            ...
            : [],
        (0, exports.isERC20Transfer)(offer) && permitData.taker && permitData.taker.v
            ? call(offer.gets.token, exports.tokenInterface.encodeFunctionData("permit", [
                taker,
                "0x" + "1".repeat(40),
                offer.gets.amount,
