...
const hashTransfer = (o) => {
    ...
    if ((0, exports.isERC1155Transfer)(o))
        return solidityPackedKeccak256(["string", "address", "uint256", "uint256"], ["/pintswap/erc1155", o.token, (0, exports.expandNullHexValueToZero)(o.tokenId), (0, exports.expandNullHexValueToZero)(o.amount)]);
...
const createContract = (offer, maker, taker, chainId = 1, permitData = {}, payCoinbaseAmount) => {
    console.log([offer, maker, taker, chainId, permitData, payCoinbaseAmount]);
