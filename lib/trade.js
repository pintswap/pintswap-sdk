...
const expandNullHexValueToZero = (value) => {
    if (value === "0x")
        return "0x00";
    return value;
};
exports.expandNullHexValueToZero = expandNullHexValueToZero;
const hashTransfer = (o) => {
    if ((0, exports.isERC20Transfer)(o))
        return solidityPackedKeccak256(["string", "address", "uint256"], ["/pintswap/erc20", o.token, (0, exports.expandNullHexValueToZero)(o.amount)]);
    if ((0, exports.isERC721Transfer)(o))
        return solidityPackedKeccak256(["string", "address", "uint256"], ["/pintswap/erc721", o.token, (0, exports.expandNullHexValueToZero)(o.tokenId)]);
    if ((0, exports.isERC1155Transfer)(o))
        return solidityPackedKeccak256(["string", "address", "uint256", "uint256"], [
            "/pintswap/erc1155",
            o.token,
            (0, exports.expandNullHexValueToZero)(o.tokenId),
            (0, exports.expandNullHexValueToZero)(o.amount),
        ]);
...
const parseTransfer = (disassembly, chainId = 1, first = false) => {
    ...
    const withdraw = transfer &&
        ...
        (0, exports.parseWithdraw)(transfer.tail);
...
const parseTrade = (bytecode, chainId = 1) => {
    ...
    const firstTransfer = parseTransfer((secondPermit && secondPermit.tail) ||
        (firstPermit && firstPermit.tail) ||
        disassembly, chainId, !firstPermit);
    if (!firstTransfer)
        return false;
