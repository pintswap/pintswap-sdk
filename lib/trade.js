...
const parseTransfer = (disassembly, chainId = 1, first = false) => {
    const transfer = (0, exports.parsePermit2)(disassembly, first);
    if (transfer === false)
        return false;
