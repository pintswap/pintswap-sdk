...
exports.createContract = exports.wrapEther = exports.toWETH = exports.setFallbackWETH = exports.WETH_ADDRESSES = exports.leftZeroPad = exports.hashOffer = exports.keyshareToAddress = exports.toBigInt = void 0;
...
const { solidityPackedKeccak256, getAddress, computeAddress, hexlify, Contract } = ethers_1.ethers;
// UTILS
function toBigInt(v) {
    if (v.toHexString)
        return v.toBigInt();
...
const toWETH = (chainId = 1) => {
    ...
    return (address || fallbackWETH || (() => {
        throw Error("no WETH contract found for chainid " + chain);
    })());
};
exports.toWETH = toWETH;
function wrapEther(signer, chainId, amount) {
    return __awaiter(this, void 0, void 0, function* () {
        const WETH = new Contract(exports.WETH_ADDRESSES[chainId], WETH9_json_1.default.abi, signer);
        const tx = yield WETH.deposit({
            value: ethers_1.ethers.parseEther(amount),
        });
        console.log("WETH Deposit TX:", tx);
        const tx2 = yield WETH.approve(yield signer.getAddress(), amount);
        console.log("WETH Approve TX:", tx2);
        return tx2;
    });
}
exports.wrapEther = wrapEther;
// SWAP CONTRACT
        ...
        if (permitData.maker && !permitData.taker) {
            if (offer.getsToken === ethers_1.ethers.ZeroAddress) {
                return (0, emasm_1.emasm)([
                    ...
                    "0x44",
                    "mstore",
                    hexlify(permitData.maker.deadline),
                    "0x64",
                    "mstore",
            ...
            if (offer.givesToken === ethers_1.ethers.ZeroAddress) {
                return (0, emasm_1.emasm)([
                    ...
                    "0x44",
                    "mstore",
                    hexlify(permitData.taker.deadline),
                    "0x64",
                    "mstore",
