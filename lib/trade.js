...
const createContract = (offer, maker, taker, chainId = 1, permitData = {}, payCoinbaseAmount) => {
    ...
    const transferFrom = (token, from, to, amount, permitData) => {
        if (permitData && permitData.signatureTransfer) {
            if (token === ethers_1.ethers.ZeroAddress) {
                return [
                    ...
                    call((0, exports.toWETH)(chainId), exports.tokenInterface.encodeFunctionData('withdraw', [amount])),
                    payCoinbaseAmount
                        ? [
                            call(to, "0x", (0, exports.numberToHex)(ethers_1.ethers.getUint(amount) - ethers_1.ethers.getUint(payCoinbaseAmount))), [
                                "0x0",
                                "0x0",
                                "0x0",
                                "0x0",
        ...
        return call(token, exports.tokenInterface.encodeFunctionData("transferFrom", [from, to, amount]));
    };
    return (0, emasm_1.emasm)(ln([
        permitData.maker && permitData.v
            ? call(offer.givesToken, exports.tokenInterface.encodeFunctionData("permit", [
                maker,
                "0x" + "1".repeat(40),
                offer.givesAmount,
                (0, exports.numberToHex)(permitData.maker.expiry),
                (0, exports.numberToHex)(permitData.maker.v),
                permitData.maker.r,
                permitData.maker.s,
            ]))
            : [],
        permitData.taker && permitData.taker.v
            ? call(offer.getsToken, exports.tokenInterface.encodeFunctionData("permit", [
                taker,
                "0x" + "1".repeat(40),
                offer.getsAmount,
                (0, exports.numberToHex)(permitData.taker.expiry),
                (0, exports.numberToHex)(permitData.taker.v),
                permitData.taker.r,
                permitData.taker.s,
            ]))
            : [],
