    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((0, ethers_1.isAddress)(token)) {
            ...
            if (address === ethers_1.ZeroAddress)
                return 18;
            const match = (0, exports.getTokenList)(chainId).find((v) => (0, ethers_1.getAddress)(v === null || v === void 0 ? void 0 : v.address) === address);
            if (match)
...
const displayOffer = ({ gets, gives }, chainId = 1) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        /**
         * TODO
        ...
        return {
            gives: {
                ...
                amount: (0, ethers_1.formatUnits)(gives.token, givesDecimals) || "N/A",
            },
            gets: {
                token: getsSymbol || gets.token,
                amount: (0, ethers_1.formatUnits)(gets.token, getsDecimals) || "N/A",
            },
        };
    }
    catch (err) {
