...
exports.hexToNumber = exports.displayOffer = exports.getName = exports.getSymbol = exports.getDecimals = exports.MIN_ABI = exports.getTokenList = exports.TOKENS = void 0;
...
function hexToNumber(value) {
    if (typeof value === "string") {
        if (ethers_1.ethers.isHexString(value)) {
            ethers_1.ethers.toNumber(value);
        }
        return Number(value);
    }
    return Number(value);
